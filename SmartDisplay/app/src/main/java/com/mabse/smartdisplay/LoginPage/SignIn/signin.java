package com.mabse.smartdisplay.LoginPage.SignIn;
...
import com.mabse.smartdisplay.LoginPage.ResetPassword.resetpass;
import com.mabse.smartdisplay.MainActivity;
...
public class signin extends AppCompatActivity {
    ...
    private void rotate() {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intnt = new Intent(getApplicationContext(), com.mabse.smartdisplay.LoginPage.SignUp.signup.class);
                startActivity(intnt);
            }
        });
