...
import com.mabse.smartdisplay.SmartScreen.ShowVideo.show_video;
...
public class AlertReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(usrTask != null && action== null && usrTask.getIsActive() && controlTaskType(usrTask) && UserUid.equals(dtbs.getUserUid())) {
            ...
            if( activityInfo.get(0).topActivity.getClassName().equals("com.mabse.smartdisplay.SmartScreen.SmartScreen") ){
